...
from model.main_model import res152_fpn_convfc_test, unet_iden_convfc_test, effib1_fpn_convfc_test, mobilev3_fpn_convfc_test, effib1_Bifpn_convfc_test, mobilev3_BiFPN_convfc_test, res152_BiFPN_convfc_test  
...
if __name__ == "__main__":
        ...
        model_test(data_csv_path = args.test_data_csv_path,
                   model_ = mobilev3_BiFPN_convfc_test,
