...
neck = BiFPN(in_channels=[16, 24, 40, 112], out_channels=256)

head = effifchead(lateral_channel=256)

effib1_Bifpn_convfc_train = IntergratedModel(backbone_train, neck, head)
effib1_Bifpn_convfc_train = effib1_Bifpn_convfc_train.cuda()

effib1_Bifpn_convfc_test = IntergratedModel(backbone_test, neck, head)
effib1_Bifpn_convfc_test = effib1_Bifpn_convfc_test.cuda()